...
from shepherd.engines.cromwell.metadata import CromwellMetadata


class TestCromwellMetadata(TestCase):

    def setUp(self):
        with open("/Users/franklinmichael/Desktop/whole_genome_germline/wdl/workflow_testing/chr19/metadata-chr19-pmac-progress.json") as meta:
